...
public class BaseController {
    ...
    public Object handlerException(HttpServletRequest request, Exception ex) {
        ...
        if (ex instanceof BusinessException businessException) {
            ...
            BusinessErrorEnum unknownError = BusinessErrorEnum.UNKNOWN_ERROR;
            log.warn("{}：{}", unknownError.getErrMsg(), ex.getMessage(), ex);
            responseData.put("errCode", unknownError.getErrCode());
            responseData.put("errMsg", unknownError.getErrMsg());
        }
